...
SECRETS=("DB_HOST" "DB_PORT" "DB_NAME" "DB_USER" "DB_PASSWORD" "FIREBASE_STORAGE_BUCKET" "NODE_ENV" "PORT" "FIREBASE_SERVICE_ACCOUNT_PATH" "UPLOADS_DIR" "EMAIL_PROVIDER" "GMAIL_USER" "GMAIL_APP_PASSWORD")
OPTIONAL_SECRETS=("SENDGRID_API_KEY" "SENDGRID_EMAIL" "SIGMA_ACCOUNT_KEY" "FCM_TOPIC_NAME_MOBILE" "FIREBASE_SERVICE_ACCOUNT")
