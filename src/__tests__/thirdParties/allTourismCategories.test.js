...
describe("All Tourism Categories API points: ", () => {
  ...
  const testTourCat0 = {
    ...
    color: "#AAFFBB",
    icon:
      global.fileManagementMicroserviceOnlineHost +
      "/api/v1/file_management/download/" +
      global.testImageInStorage,
    iconMap:
      global.fileManagementMicroserviceOnlineHost +
      "/api/v1/file_management/download/" +
      global.testImageInStorage,
  ...
  describe("Firebase - Get tokens (for web n mobile user) ", () => {
    test("Should respond with status 200 and the firebase token .", async () => {
      ...
      expect(firebaseAuthMobile.statusCode).toBe(200);
  ...
  describe("Web POST third_parties/tourism_categories ", () => {
    test("should respond with status 201 and the new object (data) after creating a new Tourism Category", async () => {
      ...
      expect(response0.body.data).toEqual(
        expect.objectContaining(testTourCat0)
      );
      const response1 = await request(usedWebHost)
        .post("/")
        .set(requestHeadersWeb)
        .send(testTourCat1);
      ...
      expect(response1.body.data).toEqual(
        expect.objectContaining(testTourCat1)
      );
    });
    ...
    test("should fail with status 400 and an error with a message if the entry is not well formatted", async () => {
      ...
      const response2 = await request(usedWebHost)
        .post("/")
        .set(requestHeadersWeb)
        .send({
          ...testTourCat0,
      ...
      const response3 = await request(usedWebHost)
        .post("/")
        .set(requestHeadersWeb)
        .send({
          ...testTourCat0,
      ...
      const response4 = await request(usedWebHost)
        .post("/")
        .set(requestHeadersWeb)
        .send({
          ...testTourCat1,
      ...
      const response5 = await request(usedWebHost)
        .post("/")
        .set(requestHeadersWeb)
        .send({
          ...testTourCat1,
      ...
      const response6 = await request(usedWebHost)
        .post("/")
        .set(requestHeadersWeb)
        .send({
          ...testTourCat1,
  ...
  describe("Web GET /third_parties/tourism_categories/ ", () => {
    ...
    test("should fail with status 400 and an error with a message if no pagination is provided", async () => {
      ...
      const response7 = await request(usedWebHost)
        .get("/")
        .set(requestHeadersWeb)
  ...
  describe("Web POST /third_parties/tourism_categories/edit ", () => {
    ...
    test("should fail with status 400 and an error with a message if the entry is not well formatted", async () => {
      ...
      const response8 = await request(usedWebHost)
        .post("/edit")
        .set(requestHeadersWeb)
        .send({
          id: testTourCat1.id,
  ...
  describe("Mobile API point: ", () => {
    describe("GET /third_parties/tourism/categories ", () => {
      test("should respond with status 200 and a list of at least two objects in the required format.", async () => {
        ...
        const response1 = await request(usedMobileHost)
          .get("/")
          .set(requestHeadersMobile)
      ...
      test("should fail with status 400 and an error with a message if pagination is wrongly provided", async () => {
        ...
        const response2 = await request(usedMobileHost)
          .get("/")
          .set(requestHeadersMobile)
          .query({ page: { size: 1 } });
        expect(response2.statusCode).toBe(400);
        ...
        const response3 = await request(usedMobileHost)
          .get("/")
          .set(requestHeadersMobile)
          .query({ page: { number: 1 } });
        expect(response3.statusCode).toBe(400);
