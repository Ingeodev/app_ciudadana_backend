...
describe("Publicity consumption API points: ", () => {
  ...
  describe("GET /notifications/publicity/banners ", () => {
    test("should respond with status 200 and a list of category objects.", async () => {
      ...
      expect(response0.body[0]).toHaveProperty("imageWeb");
      expect(response0.body[0]).toHaveProperty("url");
      expect(response0.body[1]).toHaveProperty("image");
      expect(response0.body[1]).toHaveProperty("imageWeb");
      expect(response0.body[1]).toHaveProperty("url");
      ...
      expect(response1.body[0]).toHaveProperty("imageWeb");
      expect(response1.body[0]).toHaveProperty("url");
      expect(response1.body[1]).toHaveProperty("image");
      expect(response1.body[1]).toHaveProperty("imageWeb");
      expect(response1.body[1]).toHaveProperty("url");
    });
