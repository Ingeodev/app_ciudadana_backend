...
// Deployed
// const usedHost = `${global.notificationsMicroserviceOnlineHost}/web/v1/notifications/gender_line_category`;
// Local
const usedHost = `${global.notificationsMicroserviceDefaultHost}/web/v1/notifications/gender_line_category`;
describe("Web - Gender Attention Lines management API points: ", () => {
  ...
  describe("POST /gender_line_category/ ", () => {
  ...
  describe("GET /gender_line_category/ ", () => {
    test("should respond with status 200 and a list of objects containing the gender attention lines.", async () => {
      ...
      expect(response0.body.data[0]).toHaveProperty("title");
      expect(response0.body.data[1]).toHaveProperty("id");
      expect(response0.body.data[1]).toHaveProperty("title");
    });
  ...
  describe("POST /gender_line_category/edit ", () => {
    ...
    test("should respond with status 200 and the edited object (data)", async () => {
      ...
      expect(response0.body.data.title).toBe(editGender0.title);
      ...
      expect(response1.body).toHaveProperty("data");
      expect(response1.body.data).toHaveProperty("id");
      expect(response1.body.data).toHaveProperty("title");
  ...
  describe("POST /gender_line_category/delete ", () => {
    // {
    //     "meta": null,
    //     "data": {
    //         "id": 1,
