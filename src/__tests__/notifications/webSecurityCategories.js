...
// Deployed
// const usedHost = `${global.notificationsMicroserviceOnlineHost}/web/v1/notifications/security/category`;
// Local
const usedHost = `${global.notificationsMicroserviceLocalHost}/web/v1/notifications/security/category`;
